                ...
                <div className="container">
                    <div className="row py-5">
                        ...
                        <div className="col-lg-5 offset-lg-1 mt-5 mt-lg-0">
                            ...
                            <ol id="columns-2" className="noBullets mt-5">
                                <li className="text-left mb-3"><img src={ichi} /> <br />1. ICHI</li>
                                <li className="text-left mb-3"><img src={ni} /> <br />2. NI</li>
                                <li className="text-left mb-3"><img src={san} /> <br />3. SAN</li>
                                <li className="text-left mb-3"><img src={shi} /> <br />4. SHI</li>
                                <li className="text-left mb-3"><img src={go} /> <br />5. GO</li>
                                <li className="text-left mb-3"><img src={roku} /> <br />6. ROKO</li>
                                <li className="text-left mb-3"><img src={shichi} /> <br />7. SHICHI</li>
                                <li className="text-left mb-3"><img src={hachi} /> <br />8. HACHI</li>
                                <li className="text-left mb-3"><img src={ku} /> <br />9. KU</li>
                                <li className="text-left mb-3"><img src={ju} /> <br />10. JU</li>
                                <li className="text-left mb-3"><img src={ju} /><img src={ichi} /> <br />11. JU-ICHI</li>
                                <li className="text-left mb-3"><img src={ju} /><img src={ni} /> <br />12. JU-NI</li>
                                <li className="text-left mb-3"><img src={ju} /><img src={san} /> <br />13. JU-SAN</li>
                                <li className="text-left mb-3"><img src={ju} /><img src={shi} /> <br />14. JU-SHI (etc.)</li>
                                <li className="text-left mb-3"><img src={ni} /><img src={ju} /> <br />20. NI-JU</li>
                                <li className="text-left mb-3"><img src={ni} />&nbsp;<img src={ju} />&nbsp;<img src={ichi} /> <br />21. NI-JU ICHI</li>
                                <li className="text-left mb-3"><img src={ni} />&nbsp;<img src={ju} />&nbsp;<img src={ni} /> <br />22.NI-JU NI</li>
                                <li className="text-left mb-3"><img src={ni} />&nbsp;<img src={ju} />&nbsp;<img src={san} /> <br />23. NI-JU SAN (etc.)</li>
                                <li className="text-left mb-3"><img src={san} /><img src={ju} /> <br />30. SAN-JU</li>
                            </ol>
                        </div>
                    </div>
                    <div className="row">
