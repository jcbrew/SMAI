        ...
        <div className="container py-5">
          ...
          <section>
            ...
            <div className="tab-content mt-5">
              <div id="early" className="container tab-pane active">
              ...
              <div id="karate" className="container tab-pane fade">
              ...
              <div id="historyIss" className="container tab-pane fade">
              ...
              <div id="isshinryu" className="container tab-pane fade">
                <h2>Isshinryu</h2>
